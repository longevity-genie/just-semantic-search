...
This library is designed to help in searching indexed papers but also to index the aforementioned papers.
...
2.1. you should configure a web_agent in your `agent_profiles.yaml` from the project you are working on  
```
meilisearch:
...
```
2.2. in `requiremnts.txt` you have to add `just-semantic-search-meili`
